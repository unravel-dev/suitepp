...
#define constexpr_impl_begin_branch [&](auto) -> suite::cexpr::avoid_user_return {
#define constexpr_impl_end_branch                                                                            \
	return suite::cexpr::avoid_user_return{};                                                                \
	} )

#define if_constexpr(...) suite::cexpr::caller_true().call(suite::cexpr::bool_constant<(__VA_ARGS__)>(), constexpr_impl_begin_branch
#define else_if_constexpr(...) constexpr_impl_end_branch.call(suite::cexpr::bool_constant<(__VA_ARGS__)>(), constexpr_impl_begin_branch
#define else_constexpr constexpr_impl_end_branch.call(suite::cexpr::bool_constant<true>(), constexpr_impl_begin_branch
